...
export function Registration({ setGetBack, register, setRegister, setUserpage }) {
  ...
  function registerTiktok(e) {
    e.preventDefault()
    createUserWithEmailAndPassword(auth, email, passworder)
      .then((userCredential) => {
        // Signed up 
        const user = userCredential.user;
        alert("Sesion iniciada, registre usuario")
              ...
              <form onSubmit={registerTiktok}>
                ...
                <div className="flex gap-3 flex-col">
                  ...
                  <input
                    type="text"
                    value={passworder}
                    onChange={(e) => setPassworder(e.target.value)}
