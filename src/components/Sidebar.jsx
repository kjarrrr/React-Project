                ...
                <div className="GrandContainer">
                    <div>
                        ...
                        <div className="linksContainer">
                            ...
                            <div onClick={() => { closeOnlyPanel(); setchangeColor(null); }}>
                                <div onClick={showPopUp} className={`mover3 ${changeColor === "LoadingUp" && !panel ? "active" : ""} ${panel ? "mover4" : ""} flex items-center cursor-pointer`}>
                            ...
                            <div onClick={showPopUp}>
                                <span className={`dissapear3 ${panel ? "dissapear4" : ""}`}><button className='w-55 bg-rose-500 my-4 p-2.5 rounded-md font-semibold text-white transition-all duration-300 ease-in-out hover:bg-rose-600 cursor-pointer'>Log in</button></span>
                            </div>
                                    ...
                                    <div>
                                        ...
                                        <main>
                                            <div className='flex flex-col p-2 '>
                                                <button onClick={showPopUp} >TikTok Studio</button>
